 ...
 */
public class PojoRefSpringBeanUtils extends ApplicationObjectSupport {
	...
	protected void initApplicationContext(ApplicationContext context) throws BeansException {
		...
		if(PojoRefSpringBeanUtils.applicationContext == null) {
			PojoRefSpringBeanUtils.applicationContext = context;
		}
	}
}
